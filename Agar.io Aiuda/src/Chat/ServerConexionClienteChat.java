...
public class ServerConexionClienteChat extends Thread implements Observer{
    
    private Logger log = Logger.getLogger(ServerConexionClienteChat.class);
    private Socket socket; 
    private ServerMensajesChat mensajes;
    private DataInputStream entradaDatos;
    private DataOutputStream salidaDatos;
    
    public ServerConexionClienteChat (Socket socket, ServerMensajesChat mensajes){
        this.socket = socket;
